    ...
    <div className="max-w-4xl mx-auto space-y-8 py-4">
        ...
        <div className="flex gap-3 pt-2">
          ...
          {paper.url && (
            <Button
              ...
              size="sm"
              asChild
              className="gap-2 border-zinc-200 text-zinc-600 hover:text-zinc-900 shadow-sm transition-all"
            >
      ...
      <Tabs defaultValue="summary" className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-zinc-100/50 p-1">
          <TabsTrigger
            value="summary"
            className="data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold"
          >
